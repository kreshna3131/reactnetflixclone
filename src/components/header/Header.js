...
class Header extends Component {
  ...
  componentDidMount() {
    ...
    fetch(
      `https://api.themoviedb.org/3/trending/movie/day?api_key=${process.env.REACT_APP_API_KEY}&language=en-US&include_adult=false&page=${this.random}`
    )
      .then(res => res.json())
      .then(data => {
          ...
          >
            <div className="popularInfo">
              ...
              <p className="rating">
                <em>
                  <img
                    src={require("../header/images/imdb_logo.png")}
                    alt="Rating"
                    style={{
                      width: "40px",
                      height: "20px",
