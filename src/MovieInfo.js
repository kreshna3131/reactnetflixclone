...
import PlayMovie from "./components/header/PlayMovie"
import Dialog from "@material-ui/core/Dialog"
import SimilarListsOfMovies from "./components/similar/SimilarListsOfMovies"
...
export default class MovieInfo extends Component {
  ...
  fetchMovie = () => {
    const urlMovie = fetch(
      `https://api.themoviedb.org/3/movie/${this.props.match.params.movie_id}?api_key=${process.env.REACT_APP_API_KEY}&language=en-US`
    )
    const urlCredits = fetch(`https://api.themoviedb.org/3/movie/${this.props.match.params.movie_id}/credits?api_key=${process.env.REACT_APP_API_KEY}
        `)
    const urlVideos = fetch(`https://api.themoviedb.org/3/movie/${this.props.match.params.movie_id}/videos?api_key=${process.env.REACT_APP_API_KEY}
          `)
        ...
        >
          ...
          <div className="content">
            ...
            <p className="year-run-vote">
              ...
              <span className="vote">
                <img
                  src={require("./components/header/images/imdb_logo.png")}
                  alt="Rating"
                  style={{
                    width: "40px",
                    height: "20px",
